...
//#define SUBCOPY //only copy a submatrix
//#define SUBTMP  //only copy a submatrix and put each vector into a temp matrix for bulk copy onto GPU
//no speed benefit observed on GH200, but saves a bit HBM. 
#ifdef SUBCOPY 
