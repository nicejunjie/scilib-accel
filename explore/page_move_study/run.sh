...
nvc $MEMMODE dgemm-cmp3.c -mp -Mnvpl -cuda -I${CUDA_HOME}/cuda/include -I${CUDA_HOME}/math_libs/include/ -L${CUDA_HOME}/math_libs/lib64 -lcublas -lnuma  $TMPLIB #-nvmalloc
